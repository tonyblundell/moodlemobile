var templates = [
    "root/externallib/text!root/plugins/top_navigation/navigation.html"
];

define(templates, function(navigationTpl) {
    var plugin = {
        settings: {
            name: "top_navigation",
            type: "menu",
        ...
        menuShow: function(show, settings) {
            ...
            if (!MM.navigation.isVisible) {
                ...
                var sizes = {
                    ...
                    right: {
                        left:   MM.panels.sizes.threePanels.left +
                                MM.panels.sizes.threePanels.center,
